...
### 3.1. Vorbereitung
Auch für die Web App existiert ein Grundgerüst auf github: [https://github.com/zirpins/vs1lab](https://github.com/zirpins/vs1lab). Falls git benutzt wird: Repository herunterladen (`git clone https://github.com/zirpins/vs1lab`) oder lokale Kopie aktualisieren (`git pull`).
